    ...
    public static class LogisticsExecutor
    {
        ...
        public static ExecutionResult SetPolicy(int worldId, string jsonPayload)
        {
            ...
            try
            {
                ...
                EZPlay.Core.ServiceContainer.Resolve<EZPlay.Core.Interfaces.ILogisticsManager>().RegisterPolicy(policy);
        ...
        public static ExecutionResult RemovePolicy(int worldId, string jsonPayload)
        {
            ...
            try
            {
                ...
                EZPlay.Core.ServiceContainer.Resolve<EZPlay.Core.Interfaces.ILogisticsManager>().UnregisterPolicy(data.policy_id);
